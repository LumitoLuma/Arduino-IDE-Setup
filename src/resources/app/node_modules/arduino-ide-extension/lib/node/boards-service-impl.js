...
var BoardsServiceImpl = /** @class */ (function () {
    ...
    BoardsServiceImpl.prototype.getBoardDetails = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var coreClient, client, instance, fqbn, req, resp, requiredTools, configOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        client = coreClient.client, instance = coreClient.instance;
                        fqbn = options.fqbn;
                        req = new board_pb_1.BoardDetailsReq();
                        req.setInstance(instance);
                        req.setFqbn(fqbn);
                        return [4 /*yield*/, new Promise(function (resolve, reject) { return client.boardDetails(req, function (err, resp) {
                                if (err) {
                                    reject(err);
                                    return;
                                }
                    ...
                    case 2:
                        resp = _a.sent();
                        requiredTools = resp.getRequiredToolsList().map(function (t) { return ({
                            name: t.getName(),
                            packager: t.getPackager(),
                            version: t.getVersion()
                        }); });
                        configOptions = resp.getConfigOptionsList().map(function (c) { return ({
    ...
    BoardsServiceImpl.prototype.searchBoards = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var query, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = (options.query || '').toLocaleLowerCase();
                        return [4 /*yield*/, this.search(options)];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results.map(function (item) { return item.boards.map(function (board) { return (__assign({}, board, { packageName: item.name })); }); })
                                .reduce(function (acc, curr) { return acc.concat(curr); }, [])
                                .filter(function (board) { return board.name.toLocaleLowerCase().indexOf(query) !== -1; })
                                .sort(protocol_1.Board.compare)];
                }
            });
        });
    };
                    ...
                    case 1:
                        ...
                        resp.on('data', function (r) {
                            ...
                            if (prog && prog.getFile()) {
                                _this.toolOutputService.publishNewOutput("board download", "downloading " + prog.getFile() + "\n");
                            }
                        });
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                resp.on('end', resolve);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        resp.on('data', function (_) {
                            if (!logged) {
                                _this.toolOutputService.publishNewOutput("board uninstall", "uninstalling " + pkg.id + "\n");
                                logged = true;
                            }
                        });
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
