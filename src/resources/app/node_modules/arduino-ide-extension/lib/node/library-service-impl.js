                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        resp.on('data', function (r) {
                            ...
                            if (prog) {
                                _this.toolOutputService.publishNewOutput("library download", "downloading " + prog.getFile() + ": " + prog.getCompleted() + "%\n");
                            }
                        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        resp.on('data', function (_) {
                            if (!logged) {
                                _this.toolOutputService.publishNewOutput("library uninstall", "uninstalling " + library.name + ":" + library.installedVersion + "%\n");
                                logged = true;
                            }
                        });
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
...
function toLibrary(tpl, release, availableVersions) {
    return __assign({ name: "", installable: false }, tpl, { author: release.getAuthor(), availableVersions: availableVersions, description: release.getSentence(), moreInfoLink: release.getWebsite(), summary: release.getParagraph() });
}
