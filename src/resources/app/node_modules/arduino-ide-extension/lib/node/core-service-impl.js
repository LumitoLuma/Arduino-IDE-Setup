...
var CoreServiceImpl = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                result.on('data', function (cr) {
                                    _this.toolOutputService.append({ tool: 'compile', chunk: Buffer.from(cr.getOutStream_asU8()).toString() });
                                    _this.toolOutputService.append({ tool: 'compile', chunk: Buffer.from(cr.getErrStream_asU8()).toString() });
                                });
                    ...
                    case 5:
                        e_1 = _a.sent();
                        this.toolOutputService.append({ tool: 'compile', chunk: "Compilation error: " + e_1 + "\n", severity: 'error' });
                        throw e_1;
    ...
    CoreServiceImpl.prototype.upload = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var sketchUri, fqbn, sketchFilePath, sketchpath, coreClient, client, instance, uploadReq, result, e_2;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        uploadReq = new upload_pb_1.UploadReq();
                        ...
                        result = client.upload(uploadReq);
                        _a.label = 4;
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                result.on('data', function (cr) {
                                    _this.toolOutputService.append({ tool: 'upload', chunk: Buffer.from(cr.getOutStream_asU8()).toString() });
                                    _this.toolOutputService.append({ tool: 'upload', chunk: Buffer.from(cr.getErrStream_asU8()).toString() });
                                });
                                result.on('error', function (error) { return reject(error); });
                                result.on('end', function () { return resolve(); });
                            })];
                    ...
                    case 6:
                        e_2 = _a.sent();
                        this.toolOutputService.append({ tool: 'upload', chunk: "Upload error: " + e_2 + "\n", severity: 'error' });
                        throw e_2;
