...
var settings_grpc_pb_1 = require("./cli-protocol/settings/settings_grpc_pb");
...
var ConfigServiceImpl = /** @class */ (function () {
    ...
    ConfigServiceImpl.prototype.updateDaemon = function (port, config) {
        return __awaiter(this, void 0, void 0, function () {
            var client, data;
            return __generator(this, function (_a) {
                client = new settings_grpc_pb_1.SettingsClient("localhost:" + port, grpc.credentials.createInsecure());
