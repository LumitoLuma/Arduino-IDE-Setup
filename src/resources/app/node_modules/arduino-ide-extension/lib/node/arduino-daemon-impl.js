...
var ArduinoDaemonImpl = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, exec_util_1.getExecPath('arduino-cli', this.onError.bind(this))];
                    case 1:
                    ...
                    case 1:
                        ...
                        daemon.stdout.on('data', function (data) {
                            ...
                            if (!grpcServerIsReady) {
                                ...
                                try {
                                    for (var _b = __values(['Daemon is listening on TCP port', 'Daemon is now listening on 127.0.0.1']), _c = _b.next(); !_c.done; _c = _b.next()) {
                                        var expected = _c.value;
    ...
    ArduinoDaemonImpl.prototype.onData = function (message, options) {
        ...
        if (options.useOutput) {
            this.toolOutputService.append({ tool: 'daemon', chunk: daemon_log_1.DaemonLog.toPrettyString(message) });
        }
