...
var CoreClientProvider = /** @class */ (function (_super) {
    ...
    CoreClientProvider.prototype.createClient = function (port) {
        return __awaiter(this, void 0, void 0, function () {
            var client, initReq, initResp, instance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        client = new commands_grpc_pb_1.ArduinoCoreClient("localhost:" + port, grpc.credentials.createInsecure(), this.channelOptions);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        e_1 = _b.sent();
                        this.toolOutputService.publishNewOutput("daemon", "Error while updating index in attempt " + i + ": " + e_1);
                        return [3 /*break*/, 5];
                    case 5:
                        i++;
                        return [3 /*break*/, 1];
                    ...
                    case 10:
                        e_2 = _b.sent();
                        this.toolOutputService.publishNewOutput("daemon", "Error while updating library index in attempt " + i + ": " + e_2);
                        return [3 /*break*/, 11];
                    case 11:
                        i++;
                        return [3 /*break*/, 7];
