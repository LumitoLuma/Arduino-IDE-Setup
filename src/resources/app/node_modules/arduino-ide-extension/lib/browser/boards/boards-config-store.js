...
var BoardsConfigStore = /** @class */ (function () {
    function BoardsConfigStore() {
        this.onChangedEmitter = new event_1.Emitter();
    }
    BoardsConfigStore.prototype.onStart = function () {
        var _this = this;
                    ...
                    switch (_e.label) {
                        ...
                        case 1:
                            ...
                            _b = __values(pkg.boards.map(function (_a) {
                                var fqbn = _a.fqbn;
                                return fqbn;
                            }).filter(objects_1.notEmpty).filter(function (fqbn) { return !!fqbn; })), _c = _b.next();
                            _e.label = 2;
                        case 2:
    ...
    Object.defineProperty(BoardsConfigStore.prototype, "onChanged", {
        get: function () {
    ...
    BoardsConfigStore.prototype.appendConfigToFqbn = function (fqbn, boardsPackageVersion) {
        if (boardsPackageVersion === void 0) { boardsPackageVersion = this.getBoardsPackageVersion(fqbn); }
        return __awaiter(this, void 0, void 0, function () {
            var configOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getConfig(fqbn, boardsPackageVersion)];
                    case 1:
    ...
    BoardsConfigStore.prototype.getConfig = function (fqbn, boardsPackageVersion) {
        if (boardsPackageVersion === void 0) { boardsPackageVersion = this.getBoardsPackageVersion(fqbn); }
        return __awaiter(this, void 0, void 0, function () {
            var version, key, configOptions, details;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.storageService.setData(key, configOptions)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/, configOptions];
                }
    ...
    BoardsConfigStore.prototype.setSelected = function (_a, boardsPackageVersion) {
        var fqbn = _a.fqbn, option = _a.option, selectedValue = _a.selectedValue;
        if (boardsPackageVersion === void 0) { boardsPackageVersion = this.getBoardsPackageVersion(fqbn); }
        return __awaiter(this, void 0, void 0, function () {
            var configOptions, _b, configOption, updated, _c, _d, value, version;
            var e_2, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _b = objects_1.deepClone;
                        return [4 /*yield*/, this.getConfig(fqbn, boardsPackageVersion)];
                    case 1:
                        configOptions = _b.apply(void 0, [_f.sent()]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.setConfig({ fqbn: fqbn, configOptions: configOptions, version: version })];
                    case 3:
                        _f.sent();
                        this.fireChanged();
    ...
    BoardsConfigStore.prototype.setConfig = function (_a) {
        var fqbn = _a.fqbn, configOptions = _a.configOptions, version = _a.version;
        return __awaiter(this, void 0, void 0, function () {
            var key;
            return __generator(this, function (_b) {
                key = this.getStorageKey(fqbn, version);
                return [2 /*return*/, this.storageService.setData(key, configOptions)];
            });
        });
    };
    BoardsConfigStore.prototype.getStorageKey = function (fqbn, version) {
        return ".arduinoProIDE-configOptions-" + version + "-" + fqbn;
    };
    BoardsConfigStore.prototype.getBoardDetailsSafe = function (fqbn) {
        return __awaiter(this, void 0, void 0, function () {
            var details;
            return __generator(this, function (_a) {
                try {
    ...
    BoardsConfigStore.prototype.fireChanged = function () {
        this.onChangedEmitter.fire();
    };
    BoardsConfigStore.prototype.getBoardsPackageVersion = function (fqbn) {
        return __awaiter(this, void 0, void 0, function () {
            var boardsPackage;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], BoardsConfigStore.prototype, "logger", void 0);
    __decorate([
        inversify_1.inject(protocol_1.BoardsService),
        __metadata("design:type", Object)
    ], BoardsConfigStore.prototype, "boardsService", void 0);
    __decorate([
    ...
    ], BoardsConfigStore.prototype, "boardsServiceClient", void 0);
    __decorate([
        inversify_1.inject(browser_1.LocalStorageService),
        __metadata("design:type", browser_1.LocalStorageService)
    ], BoardsConfigStore.prototype, "storageService", void 0);
    BoardsConfigStore = __decorate([
        inversify_1.injectable()
    ], BoardsConfigStore);
    return BoardsConfigStore;
}());
exports.BoardsConfigStore = BoardsConfigStore;
//# sourceMappingURL=boards-config-store.js.map