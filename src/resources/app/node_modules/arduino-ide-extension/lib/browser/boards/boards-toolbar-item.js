...
var BoardsToolBarItem = /** @class */ (function (_super) {
    ...
    BoardsToolBarItem.prototype.render = function () {
        ...
        return React.createElement(React.Fragment, null,
            ...
            React.createElement(BoardsDropDown, { coords: coords, items: availableBoards.filter(boards_service_client_impl_1.AvailableBoard.hasPort).map(function (board) { return (__assign({}, board, { onClick: function () {
